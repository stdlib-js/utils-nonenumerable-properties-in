...
```javascript
nonEnumerablePropertiesIn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-nonenumerable-properties-in@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-nonenumerable-properties-in@v0.2.2-umd/browser.js"></script>
```
